    ...
    <Link to={`/video/${video.videoId}`}>
      <div className="flex flex-col md:flex-row mb-8 md:mb-3 lg:hover:bg-white/[0.1] rounded-xl md:p-4">
        ...
        <div className="flex flex-col ml-4 md:ml-6 mt-4 md:mt-0 overflow-hidden">
          ...
          <span className="empty:hidden line-clamp-1 md:line-clamp-2 text-white/[0.7] md:pr-24 md:my-4">
          ...
          <div className="hidden md:flex items-center">
            ...
            <div className="flex flex-col ml-2">
              ...
              <div className="flex text-sm font-semibold text-white/[0.7] truncate overflow-hidden">
                ...
                <span className="flex text-[24px] leading-none font-bold relative text-white/[0.7] mx-1 top-[-10px]">
                  .
                </span>
